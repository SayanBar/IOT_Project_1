...
int32_t* allocate_memory(circular_buff_t *circ_buff)
{
...
//add item to buffer
 buffer_status put_item_tobuffer(circular_buff_t *circ_buff, int32_t data)
{
...
//read data from the buffer and remove the content saved in the buffer
 int32_t read_delete_item_frombuffer(circular_buff_t *circ_buff)
{
    buffer_status _bufferstatus;
	int32_t data;
